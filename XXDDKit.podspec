#
#  Be sure to run `pod spec lint XXDDKit.podspec' to ensure this is a
...
#   s.version      = "0.0.1"
  s.version      = "0.1.0"
  s.summary      = "XXDDKit is a collections of easy to a use source level toolkit."
  ...
  s.homepage     = "https://lzg666456.github.io/XXDDKit"
...
#   s.license      = "MIT (example)"
  ...
  # Or just: s.author    = "lzg666456"
  # s.authors            = { "lzg666456" => "lzg666456@163.com" }
  # s.social_media_url   = "http://twitter.com/lzg666456"
...
#   s.source       = { :git => "http://EXAMPLE/XXDDKit.git", :tag => "#{s.version}" }
